...
function isVoted(id, voted){
  var bool = false
  for(var i = 0; i < voted.length; i++){
    if(id === voted[i].id){
      console.log(id +'trobat')
      bool = true
    }
  }
  console.log('busqueda finalizada'+id + bool)
  return bool
        ...
        return (
          ...
          <tr>
            ...
            <td className="subtext">
              ...
              {process.env.REACT_APP_API_KEY_NAME === this.state.submission.author_username? 
              <span>
                <a className="subtext" href={"/edit"}>edit</a>{" | "}
                <a className="subtext" href={"/delete"}>delete</a>{" | "}
              </span>
              :
              this.state.userUpvoted?
